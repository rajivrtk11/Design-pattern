...
import parkinglotlld.entities.*;
import parkinglotlld.enums.VehicleSize;
import parkinglotlld.strategies.fee.VehicleBasedFeeStrategy;
...
public class Demo {
    public static void main(String[] args) {
        ...
        // 4. Simulate a vehicle entry that fails (no vailabe spots)
        Bike bike2 = new Bike("B-000");
        Optional<ParkingTicket> failedBikeOpt = parkingLot.parkVehicle(bike2);

        // 5. Simulate vehicle exit and fee calculation
        System.out.println("\n--- Vehicle Exits ---");
