...
public class Main {
    ...
    static class NorthAmericaCarFactory implements CarFactory {
    ...
    static class EuropeCarFactory implements CarFactory {
        public Car createCar() {
    ...
    static class Hatchback implements Car {
        public void assemble() {
    ...
    static class NorthAmericaSpecification implements CarSpecification {
        public void display() {
    ...
    static class EuropeSpecification implements CarSpecification {
        public void display() {
