package parkintLot3.repository;

import parkintLot3.entity.ParkingFloor;
import parkintLot3.entity.ParkingSlot;
...
public class ParkingDataRepository {
    ...
    public void initializeSlots(int noOfSlots) {
        ...
        System.out.println(parkingSlotData+"parking slot data ");
    }
